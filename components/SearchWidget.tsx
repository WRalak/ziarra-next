...
export default function SearchWidget() {
  ...
  return (
    <div className="bg-warm-white/97 rounded-[22px] p-2 flex items-center max-w-[780px] w-full shadow-hero animate-fade-up-3">
      {/* Tabs */}
      ...
      <div className="flex flex-1 items-center">
        {[
          ...
          <div key={label} className={`flex-1 px-4 ${i < arr.length - 1 ? 'border-r border-ink/10' : ''}`}>
      ...
      <button
        ...
        className="flex-shrink-0 ml-2 w-[52px] h-[52px] rounded-[14px] bg-coral hover:bg-[#c04e2a] flex items-center justify-center transition-colors duration-200"
      >
