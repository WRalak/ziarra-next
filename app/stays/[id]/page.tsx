  ...
  return (
    <div className="max-w-[1200px] mx-auto px-12 py-11">
      ...
      <div className="grid grid-cols-[1.85fr_1fr] grid-rows-[230px_230px] gap-2.5 rounded-[22px] overflow-hidden mb-9">
        <div className="row-span-2 relative"><Image src={stay.img} alt={stay.title} fill className="object-cover" /></div>
        <div className="relative"><Image src="https://images.unsplash.com/photo-1582719508461-905c673771fd?w=500&q=80" alt="" fill className="object-cover" /></div>
        <div className="relative"><Image src="https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=500&q=80" alt="" fill className="object-cover" /></div>
      </div>
      ...
      <div className="grid grid-cols-[1fr_360px] gap-12 items-start">
        ...
        <div>
          <BookingWidget price={stay.price} unit="night" rating={stay.rating} reviews={stay.reviews} cta="Reserve Now" toastMsg="🎉 Booking confirmed!" />
