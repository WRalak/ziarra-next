    ...
    <>
      ...
      <section className="bg-warm-white px-4 sm:px-6 lg:px-12 py-[88px]">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[72px] items-center">
          ...
          <div className="rounded-[22px] overflow-hidden h-[260px] sm:h-[320px] lg:h-[400px]">
            <Image src="/picc.jpg" alt="Africa" width={700} height={400} className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
