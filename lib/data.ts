...
export const STAYS = [
  { id: '1', title: 'The Serengeti Grand', location: 'Arusha, Tanzania', category: 'Hotel', badge: 'hotel', price: 240, rating: 4.97, reviews: 182, img: '/pic.jpg' },
  { id: '2', title: 'Maasai Homestead', location: 'Laikipia, Kenya', category: 'Homestay', badge: 'home', price: 68, rating: 4.94, reviews: 79, img: '/picc.jpg' },
  { id: '3', title: 'Okavango Wild Camp', location: 'Okavango Delta, Botswana', category: 'Camping', badge: 'camp', price: 45, rating: 4.91, reviews: 134, img: '/pic.jpg' },
  { id: '4', title: 'Dune Dome, Namib', location: 'Sossusvlei, Namibia', category: 'Glamping', badge: 'glamp', price: 320, rating: 5.0, reviews: 47, img: '/picc.jpg' },
  { id: '5', title: 'Zanzibar Ocean Villa', location: 'Stone Town, Zanzibar', category: 'Hotel', badge: 'hotel', price: 185, rating: 4.89, reviews: 112, img: '/pic.jpg' },
  { id: '6', title: 'Cape Winelands Farmhouse', location: 'Stellenbosch, South Africa', category: 'Homestay', badge: 'home', price: 112, rating: 4.96, reviews: 88, img: '/picc.jpg' },
]

export const EXPERIENCES = [
  { id: '1', title: 'Dawn Game Drive in the Mara', location: 'Masai Mara, Kenya', category: 'Safari', duration: '6 hrs', price: 120, rating: 4.98, reviews: 241, img: '/pic.jpg' },
  { id: '2', title: 'Coastal Swahili Kitchen', location: 'Mombasa, Kenya', category: 'Culinary', duration: '3 hrs', price: 48, rating: 4.95, reviews: 99, img: '/picc.jpg' },
  { id: '3', title: 'Kilimanjaro Summit Trek', location: 'Kilimanjaro, Tanzania', category: 'Adventure', duration: '7 days', price: 1800, rating: 4.99, reviews: 312, img: '/pic.jpg' },
  { id: '4', title: 'Zanzibar Dhow Sunset Cruise', location: 'Zanzibar, Tanzania', category: 'Coastal', duration: '2 hrs', price: 60, rating: 4.97, reviews: 176, img: '/picc.jpg' },
  { id: '5', title: 'Hot Air Balloon, Amboseli', location: 'Amboseli, Kenya', category: 'Aerial', duration: '4 hrs', price: 340, rating: 5.0, reviews: 58, img: '/pic.jpg' },
  { id: '6', title: 'Maasai Village Immersion', location: 'Narok, Kenya', category: 'Cultural', duration: 'Full day', price: 75, rating: 4.93, reviews: 201, img: '/picc.jpg' },
]
